...
export async function upsertOpenClawAuthorization(
  ...
  await execute(
    ...
    ON DUPLICATE KEY UPDATE
      ...
      allow_wallet = VALUES(allow_wallet),
      allowed_item_ids_json = VALUES(allowed_item_ids_json),
      expired_at = VALUES(expired_at),
      status = VALUES(status),
      upstream_key_id = VALUES(upstream_key_id),
      upstream_payload_json = VALUES(upstream_payload_json),
